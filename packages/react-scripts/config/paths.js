...
module.exports = {
  dotenv: resolveApp('.env'),
  appPath: resolveApp('.'),
  appBuild: resolveApp(process.env.CRA_APP_BUILD || 'build'),
  appPublic: resolveApp(process.env.CRA_APP_PUBLIC || 'public'),
  appHtml: resolveApp(process.env.CRA_APP_HTML || 'public/index.html'),
  appIndexJs: resolveApp(process.env.CRA_APP_INDEXJS || 'src/index.js'),
  appPackageJson: resolveApp('package.json'),
  appSrc: resolveApp(process.env.CRA_APP_SRC || 'src'),
  yarnLockFile: resolveApp('yarn.lock'),
  testsSetup: resolveApp(process.env.CRA_TESTS_SETUP || 'src/setupTests.js'),
  appNodeModules: resolveApp('node_modules'),
  publicUrl: getPublicUrl(resolveApp('package.json')),
  servedPath: getServedPath(resolveApp('package.json')),
